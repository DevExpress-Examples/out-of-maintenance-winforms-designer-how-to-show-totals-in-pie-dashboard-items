...
'		}
		...
		''' </summary>
		Friend ReadOnly Property CustomizePieTotals() As Byte()
			Get
				Dim obj As Object = ResourceManager.GetObject("CustomizePieTotals", resourceCulture)
		...
		'''   Looks up a localized resource of type System.Byte[].
		''' </summary>
		Friend ReadOnly Property EnablePieTotals() As Byte()
			Get
				Dim obj As Object = ResourceManager.GetObject("EnablePieTotals", resourceCulture)
				Return (DirectCast(obj, Byte()))
			End Get
		End Property
	End Module
